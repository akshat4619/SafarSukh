...
const EnterPNR = () => {
  return (
    <div className='min-h screen bg-white text-gray-800 p-8'>
        <h2 className='text-3xl font-bold mb-6 text-indigo-700'>Enter PNR Number</h2>

        <div className='bg-sky-50 p-6 rounded-lg shadow-lg max-w-xl mx-auto'>
            <label className='block mb-2 text-lg font-semibold'>PNR Number</label>
